/*
  ...
  - Added the required column `personId` to the `Post` table without a default value. This is not possible if the table is not empty.
...
-- AddForeignKey
ALTER TABLE "Post" ADD CONSTRAINT "Post_personId_fkey" FOREIGN KEY ("personId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
